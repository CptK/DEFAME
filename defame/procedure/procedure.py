...
class Procedure(ABC):
    ...
    def apply_to(self, doc: Report, structured_logger: Any | None = None) -> tuple[Label, dict[str, Any]]:
        ...
        Args:
            doc: The fact-checking report document.
            structured_logger: Optional structured logger for logging claim verification details."""
    ...
    def _develop(self, doc: Report) -> str:
        """Analyzes the currently available information and infers new insights.

        Returns:
            The elaboration text generated by the LLM."""
